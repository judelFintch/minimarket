    ...
    if ($role !== 'vendeur_simple') {
        $navSections[] = [
            ...
            'items' => [
                ...
                ['label' => 'Produits archives', 'route' => 'products.archived', 'icon' => 'M3.75 7.5A2.25 2.25 0 016 5.25h3.879a2.25 2.25 0 011.591.659l.621.621a2.25 2.25 0 001.591.659H18A2.25 2.25 0 0120.25 9.439v8.811A2.25 2.25 0 0118 20.5H6a2.25 2.25 0 01-2.25-2.25V7.5zm5.25 3.75h6m-6 3h4.5'],
    ...
    if ($role === 'admin') {
        $navSections[] = [
            ...
            'items' => [
                ...
                ['label' => 'Systeme', 'route' => 'system.index', 'icon' => 'M4.5 12a7.5 7.5 0 1115 0 7.5 7.5 0 01-15 0zm7.5-4.5v4.5l3 3'],
                ['label' => 'Sante systeme', 'route' => 'system.health', 'icon' => 'M3.75 13.5l4.5-4.5 3 3 5.25-6.75 3.75 3.75'],
            ],
        ];
    }
